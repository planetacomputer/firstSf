...
class DefaultController extends Controller
{
    ...
    public function listarAction(){
     ...
     public function verAction($id){
 	 ...
 	 public function obtenerUltimoId($m){
 	 	

 	 	return $m->obtenerUltimoId($m);
 	 }
	 ...
	 public function insertarAction(){
	     ...
	     if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	         ...
	         //Tras la insercion recuperamos de la BBDD por nombre
	     ...
	     return $this->render('AlimentosBundle:Default:formInsertar.html.twig',
	      $params);
	 }
